...
export class ApiTableSectionComponent {
  ...
  readonly apiProps: ApiProp[] = [
    ...
    },
    {
      ...
      required: false,
      default: '16px',
      description: 'Convenience input — sets both width and height. Accepts strings (e.g. "1em", "24px").',
    },
    {
      name: 'width',
      type: 'number | string',
    ...
    },
    {
      ...
      description: 'Explicit height. Overrides size; falls back to the icon\u2019s native height when unset.',
    },
    {
      name: 'color',
      type: 'string',
